...
export default function MumbaiLocation() {
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": `${siteUrl}/locations/mumbai/#localbusiness`,
      ...
      {
        "@type": "Service",
        "@id": `${siteUrl}/locations/mumbai/#service`,
      ...
      {
        "@type": "FAQPage",
        "@id": `${siteUrl}/locations/mumbai/#faq`,
        "mainEntity": [
          {
            "@type": "Question",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": `${siteUrl}/locations/mumbai/#breadcrumb`,
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
  ...
  return (
    <>
      ...
      <section className="service-hero" style={{ 
        ...
        paddingTop: "120px",
        paddingBottom: "120px",
        backgroundImage: "linear-gradient(to bottom, rgba(13, 31, 60, 0.94), rgba(13, 31, 60, 0.82)), url('/mumbai_realistic.jpg')",
