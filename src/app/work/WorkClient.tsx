        ...
        <div className="container">
          ...
          <div className="work-grid" style={{ minHeight: "300px" }}>
            {filteredProjects.map((p) => (
              <div key={p.slug} className="work-card" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", border: "1px solid var(--border)", borderRadius: "12px", overflow: "hidden", background: "var(--white)", transition: "all 0.2s" }}>

                <Link href={`/work/${p.slug}`} style={{ display: "block", width: "100%", height: "180px", overflow: "hidden", borderBottom: "1px solid var(--border)", background: "var(--off-white)", position: "relative" }}>
                  <img
                    src={p.screenshot}
                ...
                <div style={{ padding: "24px", display: "flex", flexDirection: "column", flexGrow: 1, justifyContent: "space-between" }}>
                  <div>
                    ...
                    <h3 className="work-title" style={{ fontSize: "18px", margin: "0 0 6px 0", color: "var(--navy)", fontWeight: "800" }}>
                      <Link href={`/work/${p.slug}`} style={{ color: "inherit", textDecoration: "none" }} className="hover-teal">
                        {p.client}
                      </Link>
                    </h3>
                  ...
                  <div style={{ marginTop: "16px", display: "flex", flexDirection: "column", gap: "10px" }}>
                    <Link href={`/work/${p.slug}`} className="btn btn-navy" style={{ display: "flex", gap: "6px", alignItems: "center", justifyContent: "center", width: "100%", padding: "10px" }}>
